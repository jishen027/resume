...
\basicInfo{
  ...
  \begin{itemize}[parsep=0.5ex]
    \item \textbf{Programming Languages:} JavaScript, Python, C++, Java
    \item \textbf{Tools and Frameworks:} React.js, Express.js, MongoDB, Chart.js, Vue.js, Laravel, Socket.io, Docker, Redis, Load Balancer, Azure Pipeline, Digital Ocean Droplet, Stripe API, Google Map API, Unity, OpenAI API
  \end{itemize}
