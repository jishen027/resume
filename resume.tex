...
\begin{itemize}[noitemsep]
    ...
    \item Developed a client data analytics website using \textbf{React.js, TailwindCSS, Express.js, MongoDB, MySQL} and \textbf{Chart.js}, integrating \textbf{OpenAI APIs} to provide insightful data analysis for clients.
